...
FUNCPTR	sm_FindFunction(char *name, int *priority, int *stackSize)
{
	static SymTabEntry	symbols[] =
	{
		...
		{ "bpdriver",	(FUNCPTR) bpdriver,	ICI_PRIORITY,	4096  },
		{ "bpcounter",	(FUNCPTR) bpcounter,	ICI_PRIORITY,	4096  },
		{ "ltpcounter",	(FUNCPTR) ltpcounter,	ICI_PRIORITY,	4096  },
		{ "ltpdriver",	(FUNCPTR) ltpdriver,	ICI_PRIORITY,	4096  },
