...
#	bp/library/ext/bsp/bspbab.h \
#	bp/library/ext/bsp/bspbab.c \
#	bp/library/ext/bsp/bspbcb.h \
#	bp/library/ext/bsp/bspbcb.c \
#	bp/library/ext/bsp/bspbib.h \
#	bp/library/ext/bsp/bspbib.c \
#	bp/library/ext/bsp/bsputil.h \
#	bp/library/ext/bsp/bsputil.c \
...
am__libbp_la_SOURCES_DIST = bp/dtn2/libdtn2fw.h bp/dtn2/libdtn2fw.c \
	...
	bp/library/ext/bpsec/bpsec_instr.h \
	bp/library/ext/bpsec/bpsec_instr.c \
	bp/library/ext/bpsec/bpsec_bcb.h \
	bp/library/ext/bpsec/bpsec_bcb.c \
	bp/library/ext/bpsec/bpsec_bib.h \
	bp/library/ext/bpsec/bpsec_bib.c \
	bp/library/ext/bpsec/bpsec_util.h \
...
am_libbp_la_OBJECTS = bp/dtn2/libbp_la-libdtn2fw.lo \
	...
	bp/library/ext/bpsec/libbp_la-bpsec_instr.lo \
	bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo \
...
am__EXEEXT_6 = bpadmin$(EXEEXT) bpsink$(EXEEXT) bpdriver$(EXEEXT) \
	...
	dtn2fw$(EXEEXT) dtn2adminep$(EXEEXT) ipnd$(EXEEXT) \
	beacon$(EXEEXT) node$(EXEEXT) tcpcli$(EXEEXT) tcpclo$(EXEEXT) \
	stcpcli$(EXEEXT) stcpclo$(EXEEXT) brsscla$(EXEEXT) \
	brsccla$(EXEEXT) udpcli$(EXEEXT) udpclo$(EXEEXT) \
	bibeclo$(EXEEXT) dccpcli$(EXEEXT) dccpclo$(EXEEXT) \
	dgrcla$(EXEEXT) ltpcli$(EXEEXT) ltpclo$(EXEEXT) \
	lgsend$(EXEEXT) lgagent$(EXEEXT) bptrace$(EXEEXT) \
	bping$(EXEEXT) bpnmtest$(EXEEXT) bpstats$(EXEEXT) \
	bpstats2$(EXEEXT) bpchat$(EXEEXT) hmackeys$(EXEEXT) \
	cgrfetch$(EXEEXT) $(am__EXEEXT_4) $(am__EXEEXT_5)
...
am_nm_agent_OBJECTS = nm/agent/nm_agent-ingest.$(OBJEXT) \
	...
	nm/shared/adm/nm_agent-adm_bpsec.$(OBJEXT) \
...
tests_1300_loopback_tcp_dotest_DEPENDENCIES = libici.la libbp.la \
...
SOURCES = $(libams_la_SOURCES) $(libbp_la_SOURCES) \
	...
	$(bpcp_SOURCES) $(bpcpd_SOURCES) $(bpdriver_SOURCES) \
	...
	$(dtpcadmin_SOURCES) $(dtpcclock_SOURCES) $(dtpcd_SOURCES) \
	$(dtpcreceive_SOURCES) $(dtpcsend_SOURCES) $(file2dgr_SOURCES) \
	$(file2sdr_SOURCES) $(file2sm_SOURCES) $(file2tcp_SOURCES) \
	$(file2udp_SOURCES) $(hmackeys_SOURCES) $(imcadmin_SOURCES) \
	$(imcfw_SOURCES) $(ionadmin_SOURCES) $(ionexit_SOURCES) \
	$(ionrestart_SOURCES) $(ionsecadmin_SOURCES) \
	$(ionwarn_SOURCES) $(ipnadmin_SOURCES) $(ipnadminep_SOURCES) \
	$(ipnd_SOURCES) $(ipnfw_SOURCES) $(lgagent_SOURCES) \
...
DIST_SOURCES = $(am__libams_la_SOURCES_DIST) \
	...
	$(bibeclo_SOURCES) $(bpadmin_SOURCES) $(bpcancel_SOURCES) \
	$(bpchat_SOURCES) $(bpclock_SOURCES) $(bpcounter_SOURCES) \
	$(am__bpcp_SOURCES_DIST) $(am__bpcpd_SOURCES_DIST) \
	...
	$(dtpcreceive_SOURCES) $(dtpcsend_SOURCES) $(file2dgr_SOURCES) \
	$(file2sdr_SOURCES) $(file2sm_SOURCES) $(file2tcp_SOURCES) \
	$(file2udp_SOURCES) $(hmackeys_SOURCES) \
...
am__include_HEADERS_DIST = ici/include/llcv.h ici/include/platform.h \
	ici/include/platform_sm.h ici/include/memmgr.h \
	ici/include/lyst.h ici/include/psm.h ici/include/smlist.h \
	ici/include/sptrace.h ici/include/ion.h ici/include/rfx.h \
	ici/include/ionsec.h ici/include/zco.h ici/include/sdrxn.h \
	ici/include/sdrmgt.h ici/include/sdrstring.h \
	ici/include/sdrlist.h ici/include/sdrtable.h \
	ici/include/sdrhash.h ici/include/sdr.h ici/include/smrbt.h \
	ici/include/icinm.h ltp/include/ltp.h ltp/include/sda.h \
	dgr/include/dgr.h bp/include/bp.h bp/include/eureka.h \
	bss/include/bss.h dtpc/include/dtpc.h bssp/include/bssp.h \
	ams/include/ams.h cfdp/include/cfdp.h cfdp/include/cfdpops.h
...
ACLOCAL = ${SHELL} /home/c/ion-3.5.0/missing aclocal-1.14
AMTAR = $${TAR-tar}
...
AM_CFLAGS =  -Dlinux -DSPACE_ORDER=3 -fno-strict-aliasing -DENABLE_BPACS -DENABLE_IMC -DENABLE_MANPAGES -Wall -Werror -g -include config.h \
	...
	-I$(srcdir)/bssp/include -DBPSEC $(am__append_1) \
	$(VALGRIND_COMPAT_CFLAGS)
AM_DEFAULT_VERBOSITY = 1
AM_LDFLAGS =  -lpthread
AM_LIBTOOLFLAGS = 
AR = ar
AUTOCONF = ${SHELL} /home/c/ion-3.5.0/missing autoconf
AUTOHEADER = ${SHELL} /home/c/ion-3.5.0/missing autoheader
AUTOMAKE = ${SHELL} /home/c/ion-3.5.0/missing automake-1.14
AWK = mawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/c/ion-3.5.0/missing makeinfo
MANIFEST_TOOL = :
MANOPTS = /usr/bin/man
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
PACKAGE_NAME = ion
PACKAGE_STRING = ion open source 3.5.0
PACKAGE_TARNAME = ion
PACKAGE_URL = 
PACKAGE_VERSION = open source 3.5.0
PATH_SEPARATOR = :
PDF2PS = /usr/bin/pdf2ps
PDFJOIN = /home/c/ion-3.5.0/doc/pdfjoin
POD_DOCUMENTATION = pod2man
PS2PDF = /usr/bin/ps2pdf
PSJOIN = /home/c/ion-3.5.0/doc/psjoin
RANLIB = ranlib
SED = /bin/sed
SET_MAKE = 
SHELL = /bin/bash
STRIP = strip
VALGRIND_COMPAT_CFLAGS = 
VERSION = open source 3.5.0
abs_builddir = /home/c/ion-3.5.0
abs_srcdir = /home/c/ion-3.5.0
abs_top_builddir = /home/c/ion-3.5.0
abs_top_srcdir = /home/c/ion-3.5.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/c/ion-3.5.0/install-sh
...
bpbin = bpadmin bpsink bpdriver bpsource bpecho bpcancel bpcounter \
	bplist bpsendfile bprecvfile bpclock bptransit ipnadmin ipnfw \
	bsspcli bsspclo ipnadminep dtn2admin dtn2fw dtn2adminep ipnd \
	beacon node tcpcli tcpclo stcpcli stcpclo brsscla brsccla \
	udpcli udpclo bibeclo dccpcli dccpclo dgrcla ltpcli ltpclo \
	lgsend lgagent bptrace bping bpnmtest bpstats bpstats2 bpchat \
	hmackeys cgrfetch $(am__append_8) $(am__append_9)
bplib = \
	libbp.la \
	libcgr.la \
	libstcpcla.la \
...
libbp_la_SOURCES = bp/dtn2/libdtn2fw.h bp/dtn2/libdtn2fw.c \
	...
	$(am__append_15)
libbp_la_CFLAGS = $(bpcflags) $(AM_CFLAGS) -I$(srcdir)/bp/library/ext/bpsec
...
nm_agent_SOURCES = nm/agent/ingest.c            nm/agent/lcc.c                 nm/agent/ldc.c \
					...
					nm/shared/adm/adm_agent.c nm/shared/adm/adm_bpsec.c	nm/agent/adm_bpsec_impl.c \
...
bp/library/ext/bae/libbp_la-bae.lo:  \
	bp/library/ext/bae/$(am__dirstamp) \
	bp/library/ext/bae/$(DEPDIR)/$(am__dirstamp)
bp/library/ext/bpsec/$(am__dirstamp):
	@$(MKDIR_P) bp/library/ext/bpsec
	@: > bp/library/ext/bpsec/$(am__dirstamp)
bp/library/ext/bpsec/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) bp/library/ext/bpsec/$(DEPDIR)
	@: > bp/library/ext/bpsec/$(DEPDIR)/$(am__dirstamp)
bp/library/ext/bpsec/libbp_la-bpsec_instr.lo:  \
	bp/library/ext/bpsec/$(am__dirstamp) \
	bp/library/ext/bpsec/$(DEPDIR)/$(am__dirstamp)
...
dgrcla$(EXEEXT): $(dgrcla_OBJECTS) $(dgrcla_DEPENDENCIES) $(EXTRA_dgrcla_DEPENDENCIES) 
	@rm -f dgrcla$(EXEEXT)
	$(AM_V_CCLD)$(dgrcla_LINK) $(dgrcla_OBJECTS) $(dgrcla_LDADD) $(LIBS)
...
tests/1300.loopback-tcp/dotest$(EXEEXT): $(tests_1300_loopback_tcp_dotest_OBJECTS) $(tests_1300_loopback_tcp_dotest_DEPENDENCIES) $(EXTRA_tests_1300_loopback_tcp_dotest_DEPENDENCIES) tests/1300.loopback-tcp/$(am__dirstamp)
	@rm -f tests/1300.loopback-tcp/dotest$(EXEEXT)
	$(AM_V_CCLD)$(tests_1300_loopback_tcp_dotest_LINK) $(tests_1300_loopback_tcp_dotest_OBJECTS) $(tests_1300_loopback_tcp_dotest_LDADD) $(LIBS)
...
mostlyclean-compile:
	...
	-rm -f bp/library/ext/bpsec/*.$(OBJEXT)
	-rm -f bp/library/ext/bpsec/*.lo
	...
	-rm -f tests/1300.loopback-tcp/*.$(OBJEXT)
...
include bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bcb.Plo
include bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bib.Plo
include bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_instr.Plo
include bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_util.Plo
include bp/library/ext/bpsec/$(DEPDIR)/libbp_la-profiles.Plo
...
include nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Po
...
bp/library/ext/bpsec/libbp_la-bpsec_instr.lo: bp/library/ext/bpsec/bpsec_instr.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bpsec/libbp_la-bpsec_instr.lo -MD -MP -MF bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_instr.Tpo -c -o bp/library/ext/bpsec/libbp_la-bpsec_instr.lo `test -f 'bp/library/ext/bpsec/bpsec_instr.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_instr.c
	$(AM_V_at)$(am__mv) bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_instr.Tpo bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_instr.Plo
#	$(AM_V_CC)source='bp/library/ext/bpsec/bpsec_instr.c' object='bp/library/ext/bpsec/libbp_la-bpsec_instr.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bpsec/libbp_la-bpsec_instr.lo `test -f 'bp/library/ext/bpsec/bpsec_instr.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_instr.c

bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo: bp/library/ext/bpsec/bpsec_bcb.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo -MD -MP -MF bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bcb.Tpo -c -o bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo `test -f 'bp/library/ext/bpsec/bpsec_bcb.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_bcb.c
	$(AM_V_at)$(am__mv) bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bcb.Tpo bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bcb.Plo
#	$(AM_V_CC)source='bp/library/ext/bpsec/bpsec_bcb.c' object='bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bpsec/libbp_la-bpsec_bcb.lo `test -f 'bp/library/ext/bpsec/bpsec_bcb.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_bcb.c

bp/library/ext/bpsec/libbp_la-bpsec_bib.lo: bp/library/ext/bpsec/bpsec_bib.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bpsec/libbp_la-bpsec_bib.lo -MD -MP -MF bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bib.Tpo -c -o bp/library/ext/bpsec/libbp_la-bpsec_bib.lo `test -f 'bp/library/ext/bpsec/bpsec_bib.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_bib.c
	$(AM_V_at)$(am__mv) bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bib.Tpo bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_bib.Plo
#	$(AM_V_CC)source='bp/library/ext/bpsec/bpsec_bib.c' object='bp/library/ext/bpsec/libbp_la-bpsec_bib.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bpsec/libbp_la-bpsec_bib.lo `test -f 'bp/library/ext/bpsec/bpsec_bib.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_bib.c

bp/library/ext/bpsec/libbp_la-bpsec_util.lo: bp/library/ext/bpsec/bpsec_util.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bpsec/libbp_la-bpsec_util.lo -MD -MP -MF bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_util.Tpo -c -o bp/library/ext/bpsec/libbp_la-bpsec_util.lo `test -f 'bp/library/ext/bpsec/bpsec_util.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_util.c
	$(AM_V_at)$(am__mv) bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_util.Tpo bp/library/ext/bpsec/$(DEPDIR)/libbp_la-bpsec_util.Plo
#	$(AM_V_CC)source='bp/library/ext/bpsec/bpsec_util.c' object='bp/library/ext/bpsec/libbp_la-bpsec_util.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bpsec/libbp_la-bpsec_util.lo `test -f 'bp/library/ext/bpsec/bpsec_util.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/bpsec_util.c

bp/library/ext/bpsec/libbp_la-profiles.lo: bp/library/ext/bpsec/profiles.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -MT bp/library/ext/bpsec/libbp_la-profiles.lo -MD -MP -MF bp/library/ext/bpsec/$(DEPDIR)/libbp_la-profiles.Tpo -c -o bp/library/ext/bpsec/libbp_la-profiles.lo `test -f 'bp/library/ext/bpsec/profiles.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/profiles.c
	$(AM_V_at)$(am__mv) bp/library/ext/bpsec/$(DEPDIR)/libbp_la-profiles.Tpo bp/library/ext/bpsec/$(DEPDIR)/libbp_la-profiles.Plo
#	$(AM_V_CC)source='bp/library/ext/bpsec/profiles.c' object='bp/library/ext/bpsec/libbp_la-profiles.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(libbp_la_CFLAGS) $(CFLAGS) -c -o bp/library/ext/bpsec/libbp_la-profiles.lo `test -f 'bp/library/ext/bpsec/profiles.c' || echo '$(srcdir)/'`bp/library/ext/bpsec/profiles.c
...
bp/dgr/dgrcla-dgrcla.o: bp/dgr/dgrcla.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(dgrcla_CFLAGS) $(CFLAGS) -MT bp/dgr/dgrcla-dgrcla.o -MD -MP -MF bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Tpo -c -o bp/dgr/dgrcla-dgrcla.o `test -f 'bp/dgr/dgrcla.c' || echo '$(srcdir)/'`bp/dgr/dgrcla.c
	$(AM_V_at)$(am__mv) bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Tpo bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Po
#	$(AM_V_CC)source='bp/dgr/dgrcla.c' object='bp/dgr/dgrcla-dgrcla.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(dgrcla_CFLAGS) $(CFLAGS) -c -o bp/dgr/dgrcla-dgrcla.o `test -f 'bp/dgr/dgrcla.c' || echo '$(srcdir)/'`bp/dgr/dgrcla.c

bp/dgr/dgrcla-dgrcla.obj: bp/dgr/dgrcla.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(dgrcla_CFLAGS) $(CFLAGS) -MT bp/dgr/dgrcla-dgrcla.obj -MD -MP -MF bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Tpo -c -o bp/dgr/dgrcla-dgrcla.obj `if test -f 'bp/dgr/dgrcla.c'; then $(CYGPATH_W) 'bp/dgr/dgrcla.c'; else $(CYGPATH_W) '$(srcdir)/bp/dgr/dgrcla.c'; fi`
	$(AM_V_at)$(am__mv) bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Tpo bp/dgr/$(DEPDIR)/dgrcla-dgrcla.Po
#	$(AM_V_CC)source='bp/dgr/dgrcla.c' object='bp/dgr/dgrcla-dgrcla.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(dgrcla_CFLAGS) $(CFLAGS) -c -o bp/dgr/dgrcla-dgrcla.obj `if test -f 'bp/dgr/dgrcla.c'; then $(CYGPATH_W) 'bp/dgr/dgrcla.c'; else $(CYGPATH_W) '$(srcdir)/bp/dgr/dgrcla.c'; fi`
...
nm/shared/adm/nm_agent-adm_bpsec.o: nm/shared/adm/adm_bpsec.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_bpsec.o -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Tpo -c -o nm/shared/adm/nm_agent-adm_bpsec.o `test -f 'nm/shared/adm/adm_bpsec.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bpsec.c
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bpsec.c' object='nm/shared/adm/nm_agent-adm_bpsec.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_bpsec.o `test -f 'nm/shared/adm/adm_bpsec.c' || echo '$(srcdir)/'`nm/shared/adm/adm_bpsec.c

nm/shared/adm/nm_agent-adm_bpsec.obj: nm/shared/adm/adm_bpsec.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -MT nm/shared/adm/nm_agent-adm_bpsec.obj -MD -MP -MF nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Tpo -c -o nm/shared/adm/nm_agent-adm_bpsec.obj `if test -f 'nm/shared/adm/adm_bpsec.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bpsec.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bpsec.c'; fi`
	$(AM_V_at)$(am__mv) nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Tpo nm/shared/adm/$(DEPDIR)/nm_agent-adm_bpsec.Po
#	$(AM_V_CC)source='nm/shared/adm/adm_bpsec.c' object='nm/shared/adm/nm_agent-adm_bpsec.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(nm_agent_CFLAGS) $(CFLAGS) -c -o nm/shared/adm/nm_agent-adm_bpsec.obj `if test -f 'nm/shared/adm/adm_bpsec.c'; then $(CYGPATH_W) 'nm/shared/adm/adm_bpsec.c'; else $(CYGPATH_W) '$(srcdir)/nm/shared/adm/adm_bpsec.c'; fi`
...
tests/1300.loopback-tcp/tests_1300_loopback_tcp_dotest-dotest.o: tests/1300.loopback-tcp/dotest.c
	...
	$(AM_V_at)$(am__mv) tests/1300.loopback-tcp/$(DEPDIR)/tests_1300_loopback_tcp_dotest-dotest.Tpo tests/1300.loopback-tcp/$(DEPDIR)/tests_1300_loopback_tcp_dotest-dotest.Po
#	$(AM_V_CC)source='tests/1300.loopback-tcp/dotest.c' object='tests/1300.loopback-tcp/tests_1300_loopback_tcp_dotest-dotest.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(tests_1300_loopback_tcp_dotest_CFLAGS) $(CFLAGS) -c -o tests/1300.loopback-tcp/tests_1300_loopback_tcp_dotest-dotest.o `test -f 'tests/1300.loopback-tcp/dotest.c' || echo '$(srcdir)/'`tests/1300.loopback-tcp/dotest.c
...
tests/1300.loopback-tcp/tests_1300_loopback_tcp_dotest-dotest.obj: tests/1300.loopback-tcp/dotest.c
	...
	$(AM_V_at)$(am__mv) tests/1300.loopback-tcp/$(DEPDIR)/tests_1300_loopback_tcp_dotest-dotest.Tpo tests/1300.loopback-tcp/$(DEPDIR)/tests_1300_loopback_tcp_dotest-dotest.Po
#	$(AM_V_CC)source='tests/1300.loopback-tcp/dotest.c' object='tests/1300.loopback-tcp/tests_1300_loopback_tcp_dotest-dotest.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
...
clean-libtool:
	...
	-rm -rf bp/library/ext/bpsec/.libs bp/library/ext/bpsec/_libs
...
distclean-generic:
	...
	-rm -f bp/library/ext/bpsec/$(DEPDIR)/$(am__dirstamp)
	-rm -f bp/library/ext/bpsec/$(am__dirstamp)
...
#	$(PDFJOIN) doc/ION-beginning.pdf ION-manpages.pdf --outfile ION.pdf
